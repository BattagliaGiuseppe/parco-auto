...
export default function AppShell({
  ...
  async function resolveSession(
    ...
    if (error) {
      ...
      if (currentPath !== '/onboarding') router.replace('/onboarding');
      return;
    }
    ...
    if (!onboarding && (currentPath === '/login' || currentPath === '/onboarding' || currentPath === '/')) {
  ...
  const showShell = isAuthenticated && !needsOnboarding && !publicRoutes.includes(pathname);
