    ...
    <div className={`p-6 flex flex-col gap-6 ${audiowide.className}`}>
      ...
      <section className="bg-white border rounded-xl shadow-sm p-5">
        ...
        <p className="text-gray-600 text-sm mb-3">
          Imposta pressioni, altezze e campanature per questa auto.
        </p>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          <input type="number" placeholder="Pressione ant. (bar)" className="border rounded-lg p-2" />
          <input type="number" placeholder="Pressione post. (bar)" className="border rounded-lg p-2" />
        ...
        <div className="flex justify-end mt-3">
          <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold px-4 py-2 rounded-lg">
            Salva assetto
          </button>
        </div>
      </section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {["freni", "motore", "olio", "benzina", "cambio", "elettronica"].map((item) => (
            <label key={item} className="flex items-center gap-2">
              <input type="checkbox" className="scale-125 accent-yellow-500" />{" "}
      ...
      <section className="bg-white border rounded-xl shadow-sm p-5">
        ...
        <div className="flex justify-end mb-2">
          <button className="bg-yellow-300 hover:bg-yellow-400 text-black font-semibold px-3 py-1 rounded-lg text-sm">
