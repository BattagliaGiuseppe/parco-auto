    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <SectionCard title="Sessioni evento" subtitle="Definisci le sessioni operative del weekend">
        <div className="grid grid-cols-1 gap-3 xl:grid-cols-[1fr_220px_220px]">
          ...
          {canEditEvents ? <button onClick={addSession} className="rounded-xl bg-yellow-400 px-4 py-3 font-bold text-black hover:bg-yellow-500"><PlusCircle size={16} className="mr-2 inline" />Aggiungi sessione</button> : null}
        </div>
