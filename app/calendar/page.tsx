...
import { PlusCircle, CalendarDays, Edit, Wrench } from "lucide-react";
...
export default function CalendarPage() {
  ...
  return (
    <div className={`p-6 flex flex-col gap-8 ${audiowide.className}`}>
      ...
      {/* (Il resto del codice modali rimane invariato) */}
      {modalOpen && (
        /* ... tutto il blocco che avevi già ... */
        <></>
      )}
    </div>
  );
