      ...
      <section className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="card-base p-5 md:p-6">
          ...
          <div className="flex flex-col gap-3 text-sm">
            <StatusBox label="Soglia ore" badge={thresholdBadge.label} className={thresholdBadge.className} />
            <StatusBox label="Scadenza" badge={expiryBadge.label} className={expiryBadge.className} />
            <StatusBox
