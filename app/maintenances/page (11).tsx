...
export default function MaintenancesPage() {
  ...
  async function saveMaintenance() {
    ...
    if (!editId && form.registerRevision && form.status !== "completed") {
      alert("La revisione componente può essere registrata solo su una manutenzione completata.");
      return;
    }
    ...
    try {
      ...
      if (editId) {
        ...
        const { error } = await supabase.rpc("create_maintenance_with_revision", {
