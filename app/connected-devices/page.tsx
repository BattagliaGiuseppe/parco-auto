...
type SessionRow = {
  ...
  reconciliation_status?: "pending" | "reconciled" | "needs_review" | "failed"; reconciliation_message?: string | null;
...
type PageBundle = {
  ...
  stats: { total: number; active: number; online_15m: number; sessions_30d: number; needs_review?: number };
};
...
export default function ConnectedDevicesPage() {
  ...
  const [bundle, setBundle] = useState<PageBundle>({ devices: [], cars: [], recent_sessions: [], stats: { total: 0, active: 0, online_15m: 0, sessions_30d: 0, needs_review: 0 } });
