...
type DeviceRow = {
  ...
  serial_number?: string | null; external_device_id?: string | null; source_type: string; acquisition_mode: AcquisitionMode; status: string;
